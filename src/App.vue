...
export default {
  ...
  methods: {
    getQrCode () {
      this.overdue = false
      axios.get('http://passport.bilibili.com/qrcode/getLoginUrl').then(res => {
